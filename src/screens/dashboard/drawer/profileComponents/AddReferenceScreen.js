...
export default class AddReferenceScreen extends Component {
  ...
  updateFirestoreData(screen, singleData) {
    ...
    screen.context.updateUserData(user => {
      console.log(
        'onNextClick updateFirestoreData length 2 : ' +
          this.context.userData.references.data.length,
      );
  ...
  onNextClick() {
    ...
    var filePath =
      ...
      '/' +
      this.context.utilities.strings.FS_FILE_DIR_REFERENCES;
              ...
              <View style={{alignItems: 'center', justifyContent: 'center'}}>
                <View
                  ...
                  <Image
                    ...
                    source={{uri: this.state.data.doc}}
                  />
                </View>
                <View
                  style={[
